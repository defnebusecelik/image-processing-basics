...
plt.figure(),plt.imshow(result, cmap="gray"), plt.axis("off"), plt.title("Genişleme")
...
plt.figure(), plt.imshow(opening,cmap = "gray"), plt.axis("off"), plt.title("Genişleme")
...
plt.figure(), plt.imshow(gradient,cmap = "gray"), plt.axis("off"), plt.title("Morfolojik  Gradyan")
